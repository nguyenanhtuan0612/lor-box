...
export default function SubtypeSelect(props: Props) {
  return (
    <div className="h-fit">
      ...
      <select
        ...
        id="subtype"
        className="hover:cursor-pointer block w-full xl:w-60 2xl:h-12 2xl:w-72 h-10 px-2 text-sm  border  rounded-lg bg-gray-700 border-gray-600 text-gray-200 focus:ring-blue-500 focus:border-blue-500"
      >
